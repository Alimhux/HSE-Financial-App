...
Система учета финансов для ВШЭ-Банка, разработанная с применением принципов DDD, паттернов проектирования GoF, принципов SOLID и GRASP. Выполнено в рамках домашнего задания по предмету "Конструирование ПО"
